...
AZURE_STORAGE_SECRET = k8s.V1EnvFromSource(
    secret_ref=k8s.V1SecretEnvSource(name="azure-storage")
)
...
# DVC add and push to Azure Blob Storage
...
with DAG(
    ...
    task_pull = KubernetesPodOperator(
        ...
        env_from=[GIT_SECRET, AZURE_STORAGE_SECRET],
        env_vars=COMMON_ENV,
